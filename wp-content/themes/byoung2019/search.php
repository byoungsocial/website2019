    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-none d-lg-block">
                <h1 class="text-uppercase text-light text-center text-lg-left fjalla-one display-3 mb-0"><?php the_search_query(); ?></h1>
                <h1 class="text-lowercase text-pink text-center text-lg-left bayshore display-2 mb-0 title-up">Pesquisando</h1>
            </div>
            <div class="col-12 d-block d-lg-none">
                <h1 class="text-uppercase text-light text-center text-lg-left fjalla-one display-5 mb-0"><?php the_search_query(); ?></h1>
                <h1 class="text-lowercase text-pink text-center text-lg-left bayshore display-4 mb-0 title-up">Pesquisando</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
